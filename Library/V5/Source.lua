...
function redzlib:SetTheme(NewTheme)
        ...
        SaveJson("xtray-script.json", redzlib.Save)
...
function redzlib:MakeWindow(Configs)
        local WTitle = Configs[1] or Configs.Name or Configs.Title or "Xtray Script"
        local WMiniText = Configs[2] or Configs.SubTitle or "by : XtrayScript"
